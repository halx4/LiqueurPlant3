...
public class ControlPanel extends Frame {
	...
	public ControlPanel(SiloTestServer server) {
		...
		button[10].setLabel("1k exec test");
		button[11].setLabel("1k read test");
		button[12].setLabel("5k exec test");
		button[13].setLabel("5k read test");
		button[14].setLabel("10k exec test");
		
		button[15].setLabel("10k read test");
		...
		button[21].setLabel(" 1k fill exec test");
		button[22].setLabel(" 1k read test");

...
public class SiloCodesysDriver extends PipeTailerListenerAdapter implements SiloDriverInterface,
	...
	@Override
	public liquerPlant.core.LevelSensorOutputState.state getHighLevelSensorOutput() {
		return inputs.getHighLevelSensor();
	}

	@Override
	public liquerPlant.core.LevelSensorOutputState.state getLowLevelSensorOutput() {
		return inputs.getLowLevelSensor();
	}

	@Override
	public void setMixerState(liquerPlant.core.MixerState.state newState) {
		outputs.setMixer(newState);
	}

	@Override
	public void setHeaterState(liquerPlant.core.HeaterState.state newState) {

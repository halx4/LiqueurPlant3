...
import liqueurPlant.annotationsStuff.ResourceDef;
import liqueurPlant.annotationsStuff.ServiceEnablementOp;
...
import liqueurPlant.core.SiloState;
...
public class SiloController implements SiloControllerInterface {
	...
	public String fooRead(){return "FULLVALUEFULL";}
	public void fooExec(){}
	//--------------------
	@ResourceDef(
